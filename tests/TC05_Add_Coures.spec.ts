const { test: AddCourse_Admin } = require('@playwright/test');
const ExcelJS_Addcoures_Admin = require('exceljs');

AddCourse_Admin.only("Add Courses Test", async ({ page }) => {
    AddCourse_Admin.setTimeout(2000000);

    const workbook = new ExcelJS_Addcoures_Admin.Workbook();
    await workbook.xlsx.readFile("C:\\Users\\Vivo\\Desktop\\Test_Project\\tests\\05_Data_AddCoures_Admin.xlsx");
    ...
    await page.goto('http://localhost:8083/sci_mju_lifelonglearning/course/seg123/add_course');
