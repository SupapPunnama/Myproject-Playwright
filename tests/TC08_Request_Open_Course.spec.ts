const { test: Request_open_course } = require('@playwright/test');
const ExcelJS_Request_open_course = require('exceljs');

Request_open_course.only("Request open course", async ({ page }) => {
    Request_open_course.setTimeout(3000000);

    const workbook = new ExcelJS_Request_open_course.Workbook();
    await workbook.xlsx.readFile("C:\\Users\\Vivo\\Desktop\\Test_Project\\tests\\08_Data_Request_Open_Course.xlsx");
    ...
    await page.waitForSelector("//input[@type='submit' and @value='เข้าสู่ระบบ']", { visible: true });
    ...
    await page.goto('http://localhost:8083/sci_mju_lifelonglearning/lecturer/Lecturer01/add_roc');
    ...
    while (round < 97) {
        ...
        await workbook.xlsx.writeFile("C:\\Users\\Vivo\\Desktop\\Test_Project\\tests\\08_Data_Request_Open_Course.xlsx");
